    ...
    <div className="min-h-screen relative overflow-hidden">
      ...
      <div className="absolute inset-0 z-0">
        <MapLibreMap
          ...
          pickupEta={showRouteOverlay ? getEtaMinutes() : undefined}
          ...
          <motion.div className="bg-gray-50 rounded-xl p-4">
            <div className="flex items-center justify-between">
              ...
              <motion.p
                ...
                className={`text-sm text-gray-700 text-center ${rideStatus === 'arrived' || rideStatus === 'in_progress' || rideStatus === 'started' ? 'flex-1 text-left' : 'flex-1'}`}
              >
